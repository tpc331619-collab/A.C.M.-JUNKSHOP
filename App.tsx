...
const LoginView = ({ t, onLogin }: { t: any, onLogin: () => void }) => {
  return (
...
// --- SETTINGS PAGE ---
const SettingsView = ({ t, currentLang, onLanguageChange, onBack, onLogout, user }: { t: any, currentLang: Language, onLanguageChange: (l: Language) => void, onBack: () => void, onLogout: () => void, user: User }) => {
  return (
